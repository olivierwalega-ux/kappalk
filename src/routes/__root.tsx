...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "KAPP — punkty, eventy i społeczność studencka ALK w jednej aplikacji." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "KAPP" },
      { name: "twitter:description", content: "KAPP — punkty, eventy i społeczność studencka ALK w jednej aplikacji." },
